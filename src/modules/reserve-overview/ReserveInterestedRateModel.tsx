  ...
  return (
    <ReserveNormalPaper title="Interest Rate Model">
        ...
        <Stack direction="row" justifyContent="space-between" spacing={2}>
          <Box sx={{
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginRight: "10px" }}>
              <Typography variant={"secondary14"}>Net APY</Typography>
              <span>
                <FormattedNumber
                  value={60.56}
                  variant="h3"
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginRight: "10px" }}>
              <Typography variant={"secondary14"}>Borrow Balance</Typography>
              <FormattedNumber
                value={25.56}
                variant="h3"
                symbol={'usd'}
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginRight: "10px" }}>
              <Typography variant={"secondary14"}>Supply Balance</Typography>
              <FormattedNumber
                value={60.56}
                variant="h3"
                symbol={'usd'}
      ...
      <Box sx={{
        ...
        <Typography variant={"secondary14"} style={{
          position: 'absolute',
          left: '43px',
          top: '19px',
          fontSize: '14px'
        }}>APY %</Typography>
        <DynamicReactApexChartNoSSR options={options as ApexCharts.ApexOptions} series={series} type={"area"} height={200} />
      </Box>
    </ReserveNormalPaper>
  );
}